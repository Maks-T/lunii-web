  ...
  return (
    <div className={cn("group flex flex-col h-full bg-white", className)}>
      ...
      <div className="flex flex-col flex-1 px-1">
        ...
        <p
          className="text-[13px] md:text-[14px] text-[#4B4B4B] uppercase tracking-[0.02em] font-normal leading-[1.3] mb-3">
        ...
        <div className="mt-auto">
          {is_available ? (
            <button
              ...
              className="w-full h-[54px] md:h-[60px] bg-[#1A1A21] text-white text-[13px] md:text-[14px] font-bold tracking-[0.2em] uppercase transition-all duration-300 hover:bg-[#C5B4A2] active:scale-[0.99] cursor-pointer flex items-center justify-center"
            >
              В КОРЗИНУ
            </button>
          ) : (
            <div
              className="w-full h-[54px] md:h-[60px] bg-[#D1D5DB] text-white text-[13px] md:text-[14px] font-bold tracking-[0.2em] uppercase flex items-center justify-center cursor-default select-none"
            >
              ОЖИДАЕТСЯ
            </div>
          )}
